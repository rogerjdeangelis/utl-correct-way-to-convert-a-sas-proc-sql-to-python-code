# utl-correct-way-to-convert-a-sas-proc-sql-to-python-code
Converting SAS SQL to Python, WPS, R and Python  
    %let pgm=utl-correct-way-to-convert-a-sas-proc-sql-to-python-code;

    Converting SAS SQL to Python, WPS, R and Python

    Too long a post for SAS-L, see git hub

    Related python repositories on end

    github
    https://tinyurl.com/mmyk74sh
    https://github.com/rogerjdeangelis/utl-correct-way-to-convert-a-sas-proc-sql-to-python-code
    ...
    Left join column bmi to class dataset drop Alice row and chage bmi in languaages python wps sas and r
    ...
    */
    ...
    Correct way to convert a sas proc sql to python code
